...
### 앱 인스턴스 얻기 <a id="getting_the_app_instance"></a>
...
### 백그라운드에서 컨텐츠 가져오기 <a id="fetching_content_in_the_background"></a>
...
### 보호된 컨텐츠의 가용성 결정 <a id="determining_the_availability_of_protected_content"></a>
